  ...
  if (normalized === 'idb') {
    return {
      ...
      capabilities: {
        ...
        organization: { available: false, provider: 'unavailable', usesMockData: true },
        missions: { available: false, provider: 'unavailable', usesMockData: true },
        commercial: { available: false, provider: 'unavailable', usesMockData: false },
        announcements: { available: false, provider: 'unavailable', usesMockData: false },
