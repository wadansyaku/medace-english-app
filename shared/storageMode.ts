  ...
  if (normalized === 'idb') {
    return {
      ...
      capabilities: {
        ...
        organization: { available: true, provider: 'idb', usesMockData: true },
        missions: { available: true, provider: 'idb', usesMockData: true },
        commercial: { available: true, provider: 'idb', usesMockData: true },
        announcements: { available: true, provider: 'idb', usesMockData: true },
